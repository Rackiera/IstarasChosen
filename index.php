...
<section>
	...
	<article>
		...
		<br/>
			<div style="text-align:center;"><p>Hello there and welcome to the homepage of Istara's Chosen (IC)! We are a guild based primarily on the Chaos server whose primary goal in the game is to sit back, relax, and have fun. We are all here just to enjoy this game to its fullest without any overbearing expectations or restrictive requirements.</p>
		...
		<header class="article border">Joining Istara's Chosen</header>
			...
			<p>We are generally a very forgiving guild and are willing to give people chances as needed, but we are very strict on anti-drama mongering and anti-exploiting. If you have a history of either of these, don't expect easy membership or to be in the guild very long if you are accepted.</p>
</article>
	<!--BEGIN SIDEBAR -->
